...
#
#
# # def print_hi(Dongdong):
# #     # Use a breakpoint in the code line below to debug your script.
# #     print(f'Hi, {Dongdong}')  # Press Ctrl+F8 to toggle the breakpoint.
# #
# #
...
# LivT_cells = cell_metadata.index[cell_metadata['celltype.stim'] == '0: Hepatocytes1_Group2']
# LivC_cells = cell_metadata.index[cell_metadata['celltype.stim'] == '0: Hepatocytes1_Group1']
#
...
#     axs.annotate('Hepatocytes1_treat', xy=(0.55, -0.12), xycoords='axes fraction', fontsize=16)
#     axs.annotate('', xy=(0.5, -0.08), xycoords='axes fraction', xytext=(1, -0.08),
#             arrowprops=dict(arrowstyle="<-", color='#E92E87', linewidth=4))
#     axs.annotate('Hepatocytes1_control', xy=(0.05, -0.12), xycoords='axes fraction', fontsize=16)
#     for r in data.index:
...
# axs.set_title("Differential Metabolic Activity in hepatocytes", fontsize=14)
# plt.tight_layout()
